...
\usepackage[left=3.05cm,top=1.8cm,right=1.6cm,bottom=2.75cm]{geometry} % (2) -- стандарт
...
% \setlength{\footskip}{\paperheight-(1in+\voffset+\topmargin+\headheight+\headsep+\textheight)-1.7cm}
